...
static const int APPS_SEARCH_INITIAL_LIMIT = 12;
    ...
    static NSString *const kIPARangerVersion = @"IPA Ranger version: 2.3.0+exp1 (rootless)";
#else
    /** ROOTFUL CONSTANTS **/
    // default
    ...
    static NSString *const kIPARangerVersion = @"IPA Ranger version: 2.3.0+exp1 (rootful)";
#endif

static NSString *const kIPARCountryChangedNotification = @"com.0xkuj.iparanger.countryChanged";
static NSString *const kIPARDownloadBundleNotification = @"com.0xkuj.iparanger.downloadBundle";
static NSString *const kIPARDownloadBundleUserInfoKey = @"bundleID";
...
static NSString *const kAppMinimumOSIndex = @"minimumOS";
static NSString *const kAppAccountEmailIndex = @"accountEmail";
...
static NSString *const kAccountsKeyFromFile = @"Accounts";
static NSString *const kActiveAccountIdKeyFromFile = @"ActiveAccountId";
static NSString *const kDownloadedAccountsKeyFromFile = @"DownloadedAccounts";
static NSString *const kAccountIdKey = @"id";
static NSString *const kAccountLabelKey = @"label";
static NSString *const kAccountHomeKey = @"home";
static NSString *const kAccountStorefrontKey = @"storefront";
static NSString *const kAccountKeychainServiceKey = @"keychainService";
static NSString *const kDefaultIpatoolKeychainService = @"ipatool-auth.service";
...
static NSString *const kKeyToExtractPlutilMinimumOS = @"MinimumOSVersion";
